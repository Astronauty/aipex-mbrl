...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    ### Temporary force
    # agent_cfg.class_name = "MBPOOnPolicyRunner"
    ...
    elif agent_cfg.class_name == "TDMPCRunner":
        runner = TDMPCRunner(env, agent_cfg.to_dict(), log_dir=log_dir, device=agent_cfg.device)
    else:
